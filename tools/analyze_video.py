...
def analyze_frames(frames, max_frames=30):
    ...
    content.append({
        ...
        "text": (
            ...
            "This THR number is on the DRIFTCOACH app (the larger HUD panel), NOT on "
            "the vertical ThrottleMeter. Look for 'THR:' followed by a number on the "
            "DriftCoach panel near the throttle bar. "
